...
#This script runs a speed test on the target computer and emails the result back to you. 
...
function sendMail ($subject, $message)
{
    ...
    $EmailSender = "noreply@Truenorthsteel.com"
    $emailPassword = "TrueNorthSteel1945!"
    $port = '587'
    $from = "noreply@TrueNorthSteel.com"
    $to = "Robert.Gelin@TrueNorthSteel.com"
